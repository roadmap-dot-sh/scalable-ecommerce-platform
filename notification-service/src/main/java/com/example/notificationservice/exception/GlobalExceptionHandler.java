...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> notFound(TemplateNotFoundException ex) {
        return body(HttpStatus.NOT_FOUND, ex.getMessage());
    }

    @ExceptionHandler({NotificationFailedException.class, IllegalArgumentException.class})
